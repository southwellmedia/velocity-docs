---
title: "Upgrade: v0.2.0-beta to v0.3.0-beta"
description: Step-by-step guide for upgrading Velocity from v0.2.0-beta to v0.3.0-beta
sidebar:
  order: 3
  badge:
    text: Latest
...
- [Changelog](/reference/changelog/) — Full release notes for v0.3.0-beta
