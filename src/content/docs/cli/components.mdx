...
|--------|-----------------|
| **All components** | Full 40+ component library with UI, patterns, and hero sections |
...
| `Tabs` | overlay | Horizontal tab navigation |
| `VerticalTabs` | overlay | Vertical tab navigation |
| `Accordion` | overlay | Collapsible content sections |
